    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link"  href="{{ route('home.index') }}">যোগাযোগ</a><br>
                <a class="footer-link"  href="{{ route('project.index') }}">প্রজেক্ট সমূহ</a><br>
                <a class="footer-link"  href="{{ route('course.index') }}">কোর্স সমূহ </a><br>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
                <h3 class="service-card-title">আইনি</h3>
                <hr>
                <a class="footer-link" target="_blank" href="{{ route('policy.index') }}">প্রাইভেসি পলিসি</a><br>
                <a class="footer-link" target="_blank" href="{{ route('terms.index') }}">শর্ত সমূহ </a><br>
            </div>
        </div>
    </div>
</div>
